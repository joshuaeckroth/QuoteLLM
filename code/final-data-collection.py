...
for directory in directories:
    ...
    csv_path = "./QuoteLLM/all-models-results/CSVs/"
    ...
    with open(csv_file, "w") as csvfile:
        ...
        csvwriter.writerow(
            ["model", "file", "randtoken", "randtoken_count", "gt", "gt_portion", "pred", "answer",
             "levenshtein_distance", "full_pred", "full_answer", "optimal_cosine", "optimal_index", "cosine_scores",
        ...
        for transcript_file in glob.glob(
                f"/Users/skyler/Desktop/QuoteLLM/transcripts/final-transcripts/gibberish-article/*"):
            ...
            prompt = f"Finish the rest of the paragraph. It is from the article 'Capitalist Narrative in the Works of Gibson' by Henry O. C. d’Erlette."
                    ...
                    for model in models_list:
                        ...
                        try:
                            ...
                            for k in range(len(input_lengths)):
                                embedding_1 = embedding_model.encode(token_enc.decode(trimmed_gt),
                            ...
                            csvwriter.writerow(
                                [model, title, randtoken, randtoken_count, token_enc.decode(gt_quote),
                                 begin_quote_tokens,
                                 pred_tokens, trimmed_tokens, dist, token_enc.decode(pred_doc),
                                 token_enc.decode(trimmed_gt), optimal_cosine, optimal_index, scores, start_token,
                                 end_token])
...
"""
    ...
    for model in models_list:
        ...
        graph_path = f"/home/haleystinebrickner/QuoteLLM/all-results/"  # sending graphs to results path (in graph directory)
