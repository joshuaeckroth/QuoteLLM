...
for model in model_list:
    ...
    graph_filename = f'/Users/skyler/Desktop/QuoteLLM/all-models-results/visualization/cosine-ecdf-plot-{model}.png'
    ...
    graph_title = f"Cosine Vector Comparison Scores with {model}"
    ...
    filenames.append(f'/Users/skyler/Desktop/QuoteLLM/all-models-results/CSVs/{model}/gpt-results.csv')
    filenames.append(f'/Users/skyler/Desktop/QuoteLLM/all-models-results/CSVs/{model}/gibberish-article-results.csv')
    ...
    with open(
            f'/Users/skyler/Desktop/QuoteLLM/all-models-results/visualization/ecdfs/cosine-ecdf-table-{model}.tex',
            'w') as tf:
...
with open(f'/Users/skyler/Desktop/QuoteLLM/all-models-results/visualization/ecdfs/cosine-ecdf-table.tex',
            'w') as tf:
