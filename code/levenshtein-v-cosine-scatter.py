...
for model in model_list:
    ...
    for filename in filenames:
        ...
        plt.title(f"{metric} vs. Optimal Cosine for GPT Story with {model}")
        plt.scatter(x, y)  # Plot the chart
        plt.gca().invert_yaxis()
        plt.savefig(f"/Users/skyler/Desktop/QuoteLLM/all-models-results/visualization/cosine_levenshtein_scatter_plots/gpt_story_{metric}_v_cosine-{model}.png")
        plt.show()  # display
